...
class Controller:
    ...
    def callback(self, data):
        ...
        message = transfer()
        message.speed = math.sqrt(
            self.xAxes ** 2 + self.yAxes ** 2)  # Umrechnung auf Geschwindigkeit aus den Achsenpositionen des l. Stock
        message.angle = math.atan2(self.yAxes,
                                   self.xAxes) / math.pi  # Umrechnung Bogenmaß aus den Achsenpositionen des l. Stock
