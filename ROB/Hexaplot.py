...
class Hexaplot:
    ...
    def __init__(self, height, hex_coord, ax_limits=None, plt_pause_value=0.05, dot_color='white', line_color='black',
                 show_lines=False):
    ...
    def show_plot(self):
        while True:
            ...
            if data != None:
                formatted_data = []
                for line in data:
                    formatted_data.append([[line[0][0] * 100, line[0][1] * 100, line[0][2] * 100],
                                           [line[1][0] * 100, line[1][1] * 100, line[1][2] * 100]])
                data = formatted_data
